...
<p align="center">
  ...
  Leverages foundation models to generate domain-specific examples through an intuitive web interface.<br> Helping ML engineers and organizations easily generate high-quality, domain-specific data for custom AI solutions.
